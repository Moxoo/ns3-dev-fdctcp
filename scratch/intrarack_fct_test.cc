...
int main (int argc, char *argv[])
{
  ...
  std::string queue_limit = "75p";//almost 4MB buffer
  ...
  uint64_t data_mbytes_short = 200*1024;//1MB/100KB
  double minRto = 0.01;//5ms
  ...
  cmd.AddValue ("PACKET_SIZE", "Packet size", IP_PACKET_SIZE);
  ...
  ftpShort.SetAttribute("SendSize", UintegerValue(TCP_SEGMENT));
  ...
  myfile << "PACKET_SIZE " << IP_PACKET_SIZE << "\n";
